...
// Tous les noms de dossiers ont été vérifiés via l'API git-tree du dépôt (873 exercices).
const IMG_MAP = {
  // ── Échauffement ──────────────────────────────────────────────────────
  'Rotation externe d\'épaule à la poulie (coude au corps)': 'External_Rotation_with_Cable',
  'Rotation interne d\'épaule à la poulie (coude au corps)': 'Cable_Internal_Rotation',
  'Rotation externe d\'épaule à la poulie (bras à 90°)':     'External_Rotation_with_Cable',
  ...
  'Rowing à la machine':                      'Leverage_Iso_Row',
  ...
  'Élévations latérales câble':               'Cable_Seated_Lateral_Raise',
  ...
  'Curl câble basse poulie':                  'Standing_Biceps_Cable_Curl',
  'Curl marteau câble':                       'Cable_Hammer_Curls_-_Rope_Attachment',
  // ── Triceps ───────────────────────────────────────────────────────────
  ...
  'Extensions triceps haltère':               'Standing_Dumbbell_Triceps_Extension',
  'Extensions triceps haltère couché':        'Lying_Dumbbell_Tricep_Extension',
  ...
  'Soulevé de terre jambes tendues haltères': 'Stiff-Legged_Dumbbell_Deadlift',
  'Hip thrust':                               'Barbell_Hip_Thrust',
  'Hip thrust machine':                       'Barbell_Hip_Thrust',
  'Abducteur machine':                        'Thigh_Abductor',
  ...
  'Planche':                                  'Plank',
  'Planche latérale':                         'Push_Up_to_Side_Plank',
  ...
  // ── Cardio ────────────────────────────────────────────────────────────
  'Marche':                                   'Walking_Treadmill',
  'Course à pied':                            'Jogging_Treadmill',
  'Vélo stationnaire':                        'Bicycling_Stationary',
  'Vélo elliptique':                          'Elliptical_Trainer',
